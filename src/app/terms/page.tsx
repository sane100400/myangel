...
const TERMS_SECTIONS = [
  ...
  {
    title: "6. 저작권·상표권과 AI 생성물",
    body: [
      "AI 생성·편집 결과물의 권리 상태와 상업적 사용 가능성은 입력 이미지, 프롬프트, 사람의 창작적 수정, 사용 지역의 법률에 따라 달라질 수 있습니다.",
      "서비스는 생성·편집 결과물이 저작권 등록 가능하거나 제3자 권리를 침해하지 않는다고 보장하지 않습니다.",
      "기존 캐릭터, 프랜차이즈, 브랜드 로고, 상표, 현존 작가나 스튜디오의 고유한 스타일을 무단으로 재현·복제하는 요청은 제한될 수 있습니다.",
      "사용자는 AI로 생성·편집된 콘텐츠를 외부에 게시하거나 상업적으로 이용할 때 AI 사용 사실과 필요한 권리 확인 책임을 부담합니다.",
    ],
  },
  {
    title: "7. 금지 행위",
